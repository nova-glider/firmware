...
// we define these as inline because we don't want them to be actual function
// calls (they get "called" from the cubemx autogenerated user_diskio file) we
// define them as extern because they are defined in a separate .c file to
// user_diskio.c (which #includes this .h file)
