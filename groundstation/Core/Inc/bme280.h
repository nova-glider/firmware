...
#define TEMP_XLSB_REG_ADDR                                                     \
  0xFC /*!Contains XLSB part of raw temperature data, depends on pressure      \
          resuliton */
...
#define PRESS_XLSB_REG_ADDR                                                    \
  0xF9 /*!Contains XLSB part of raw pressure data, depends on temperature      \
          resuliton */
...
#define RAWDATA_BASEADDR                                                       \
  PRESS_MSB_REG_ADDR /*!Base address of Raw data registers */

#define CONFIG_REG_ADDR                                                        \
  0xF5 /*!Sets the rate, filter and enable or disable 3-wire SPI interface*/
#define CTRL_MEAS_REG_ADDR                                                     \
  0xF4 /*!Control oversampling of temp and press and changes sensor modes */
#define STATUS_REG_ADDR                                                        \
  0xF3 /*!Contains 2 bits which indicate status of BME280*/
#define RESET_REG_ADDR                                                         \
  0xE0 /*!BME280 RESET register, to reset BME280, 0xB6 must be written to this \
          register*/
#define CHIP_ID_REG_ADDR                                                       \
  0xD0 /*!Contains chip number of BME280, which is                             \
          0x60*/

#define CTRL_HUM_REG_ADDR                                                      \
  0xF2 /*!Controls oversampling of humidity data.                              \
        * NOTE: This register must be written before changing ctrl_meas        \
        * register                                                             \
        */

#define CALIB_DATA00_25_BASEADDR                                               \
  0x88 /*!Base address of calib registers which contains compensation words    \
          from 0 to 25*/
#define CALIB_DATA26_41_BASEADDR                                               \
  0xE1 /*!Base address of calib registers which contains compensation words    \
          from 26 to 41*/
